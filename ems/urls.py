...
from .views import index, app_calendar, user_account, app_kanban, add_parish_details, view_parish_details, add_event_type, event_page, save_event, delete_event
...
urlpatterns = [
    ...
    path("view_parish_details/", view_parish_details, name="view_parish_details"),
